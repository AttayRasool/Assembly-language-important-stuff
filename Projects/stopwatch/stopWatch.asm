...
jmp start
data:db 'Press R for Reset'
length:
data1:db 'Press spacebar for start'
length1:
data3:db 'WELCOME TO THE STOPWATCH'
length3:
data4:db 'press any key to next screen'
length4:
